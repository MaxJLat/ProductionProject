...
* This class is designed to be used as a way to organize connecting to the database
* Removes repetitive code from other classes that call it's methods.
* Works with embedded h2 database*/
